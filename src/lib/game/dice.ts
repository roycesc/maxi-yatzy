/**
 * Dice utilities for Maxi Yatzy game
 * Maxi Yatzy is played with 6 dice.
 */
...
/**
 * Rolls a specified number of dice (defaults to 6 for Maxi Yatzy).
...
/**
 * Rerolls specific dice based on which ones are held.
